...
//         minHeight: "100vh",
//         backgroundImage:
//           "url('https://aakashshrivastav.in/wp-content/uploads/2025/09/intercontinental-bali-9719167392-4x3-1-1024x768.jpg')",
//         backgroundSize: "cover",
//         backgroundPosition: "center",
//         position: "relative",
//         display: "flex",
...
import { registerUser } from "../api/auth.api";
import { useNavigate, Link } from "react-router-dom";
import registerImage from "../assets/register.jpg"; // <-- Corrected path
...
const Register = () => {
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        backgroundImage: `url(${registerImage})`, // <-- Local image
        backgroundSize: "cover",
        backgroundPosition: "center",
        position: "relative",
        display: "flex",
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "1.5rem" }}>
          ...
          <p style={{ opacity: 0.9 }}>Sign up to get started with your account</p>
        </div>
