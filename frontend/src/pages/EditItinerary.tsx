                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    id="activities"
                                    name="activities"
                                    placeholder="Enter activities separated by commas (e.g., Visit Eiffel Tower, Louvre Museum, Seine River Cruise)"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        name="lodging"
                                        type="text"
                                        placeholder="e.g., Hotel Le Grand Paris"
                                        value={form.lodging}
                                        onChange={handleChange}
                                        className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent transition-all"
                                    />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="dining"
                                    type="text"
                                    placeholder="e.g., French cuisine, vegetarian options"
                                    value={form.dining}
                                    onChange={handleChange}
