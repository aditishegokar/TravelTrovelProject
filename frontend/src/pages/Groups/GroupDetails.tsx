...
const GroupDetails: React.FC = () => {
    ...
    const handleInvite = async (e: React.FormEvent) => {
        ...
        const userToInvite = allUsers.find(u => u.email === inviteEmail);
        ...
        if (group?.members.some(m => m._id === userToInvite._id)) {
        ...
        return (
            <Layout>
                <div className="flex items-center justify-center h-[70vh]">
                    <div className="animate-spin h-12 w-12 rounded-full border-4 border-gray-300 border-t-gray-900" />
                </div>
            </Layout>
        );
    }
        ...
        return (
            <Layout>
                <div className="text-center py-20">
                    <h2 className="text-2xl font-semibold text-gray-700">Group not found</h2>
                    <button
                        onClick={() => navigate('/groups')}
                        className="mt-6 px-5 py-2 rounded-lg border hover:bg-gray-100"
                    >
                        Back to Groups
                    </button>
                </div>
    ...
    return (
        <Layout>
            <div className="max-w-7xl mx-auto px-4 py-8">
                {/* Header */}
                <div className="bg-white/80 backdrop-blur border rounded-2xl p-6 shadow-sm mb-8">
                        ...
                        {isOwner && (
                            <div className="bg-white rounded-2xl border shadow-sm p-6">
                                ...
                                <form onSubmit={handleInvite} className="space-y-3">
                                    ...
                                    />
                                    <button className="w-full py-2 rounded-lg bg-gray-900 text-white">
                                        Send Invite
                                    </button>
                                </form>
