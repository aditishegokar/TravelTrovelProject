    ...
    return (
        <Layout>
            <div
                ...
                style={{
                    backgroundImage:
                        "url('https://thelocaltourist.com/wp-content/uploads/2023/05/Road-Trip-Along-the-Coast.jpg')", // you can replace this with any travel image
                }}
            >
                {/* Overlay */}
                <div className="min-h-screen backdrop-blur-sm bg-gradient-to-b from-black/20 via-black/10 to-black/30 px-4 py-12">
                    <div className="max-w-4xl mx-auto bg-white/90 rounded-3xl p-8">
                        {/* Back Button */}
                        <button
                            onClick={() => navigate("/my-itineraries")}
                            className="flex items-center gap-2 text-gray-600 hover:text-gray-900 mb-6 transition-colors"
                        ...
                        {/* Activities, Lodging, Dining Sections */}
